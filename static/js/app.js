 ...
 */
const APP_VERSION = "hybrid-roadmap-049-colored-stroke-order";
...
const HIRAGANA_STROKE_PATHS = {
    'あ': ['M18 33 C34 36 58 32 78 26', 'M48 14 C45 34 45 56 50 76', 'M31 54 C18 75 39 91 61 75 C80 58 70 38 48 43'],
    'い': ['M27 18 C21 42 25 66 42 78', 'M72 27 C77 43 78 58 70 74'],
    'う': ['M37 18 C47 16 58 18 66 23', 'M28 43 C46 34 72 38 68 56 C65 72 49 80 34 84'],
    'え': ['M38 18 C49 17 60 20 68 24', 'M26 43 C44 35 63 36 72 43 C60 51 48 61 38 78 C49 68 62 70 75 76'],
    'お': ['M20 35 C39 36 58 33 77 28', 'M48 13 C45 35 44 57 49 78 C34 89 18 78 30 63 C40 50 58 49 70 58', 'M77 36 C85 42 88 51 86 60'],
    'か': ['M22 34 C40 36 59 30 73 22 C69 47 56 69 38 82', 'M45 15 C33 43 28 64 30 82', 'M76 45 C84 51 88 61 88 72'],
    'き': ['M20 25 C40 29 60 28 80 22', 'M18 43 C42 47 62 45 82 38', 'M50 14 C52 38 59 58 72 77 C52 70 38 72 28 80'],
    'く': ['M65 17 C52 33 39 47 27 58 C42 68 55 78 70 90'],
    'け': ['M27 17 C22 37 22 60 29 80', 'M49 34 C61 35 72 34 84 31', 'M68 16 C69 39 68 62 54 82'],
    'こ': ['M25 31 C42 36 60 35 76 30', 'M21 72 C38 78 63 78 82 71'],
    'さ': ['M19 31 C39 35 60 33 82 27', 'M51 14 C52 39 59 59 74 75', 'M28 79 C41 71 56 70 70 78'],
    'し': ['M36 18 C31 45 35 72 56 82 C64 85 73 82 80 76'],
    'す': ['M18 34 C40 36 62 35 84 30', 'M55 14 C55 34 57 50 58 65 C58 79 41 82 40 68 C39 55 59 52 69 65'],
    'せ': ['M18 36 C38 38 61 36 84 31', 'M35 18 C34 39 34 56 38 74', 'M67 16 C67 35 64 50 55 61'],
    'そ': ['M28 22 C43 25 58 24 73 20 C61 35 45 48 29 60 C47 58 65 62 81 76'],
    'た': ['M20 32 C36 34 54 32 72 28', 'M45 15 C42 37 37 61 28 82', 'M61 44 C72 46 80 45 88 42', 'M60 75 C70 80 80 80 88 75'],
    'ち': ['M19 32 C38 36 58 34 80 28', 'M48 15 C45 38 43 54 39 68 C52 57 73 61 74 75 C75 87 56 91 38 84'],
    'つ': ['M18 45 C38 35 72 34 79 52 C87 75 58 86 34 80'],
    'て': ['M20 31 C41 33 62 31 82 27 C60 39 45 54 48 70 C50 80 60 84 73 82'],
    'と': ['M42 18 C47 34 53 47 59 59', 'M74 31 C51 40 31 55 31 70 C31 83 55 84 78 76'],
    'な': ['M20 33 C40 36 61 33 80 27', 'M47 15 C43 39 36 62 25 82', 'M76 36 C83 42 87 51 88 62', 'M58 67 C47 70 45 83 59 86 C74 89 78 75 67 65'],
    'に': ['M27 18 C22 42 22 64 28 82', 'M55 35 C65 37 76 36 84 32', 'M53 73 C64 79 77 78 88 72'],
    'ぬ': ['M30 19 C39 44 52 63 70 79', 'M70 23 C46 32 25 53 26 72 C27 91 57 91 72 72 C84 55 80 37 65 30'],
    'ね': ['M28 17 C27 39 25 61 24 84', 'M19 48 C31 41 42 35 51 28 C48 45 46 61 47 83 C59 66 72 58 82 66 C91 72 85 84 73 82'],
    'の': ['M55 20 C35 25 24 42 25 60 C26 78 48 83 63 70 C78 57 77 33 55 20'],
    'は': ['M27 18 C22 42 22 64 28 82', 'M55 36 C66 38 76 37 85 33', 'M70 18 C70 42 68 62 64 82 C50 84 48 70 62 67 C74 64 83 72 88 79'],
    'ひ': ['M24 22 C36 58 52 84 73 72 C87 63 81 42 64 25'],
    'ふ': ['M45 17 C54 21 60 26 64 33', 'M49 42 C43 54 38 67 29 78', 'M24 56 C17 63 14 70 14 78', 'M72 55 C82 63 88 72 90 82'],
    'へ': ['M18 61 C33 45 43 34 54 34 C65 39 75 51 88 64'],
    'ほ': ['M26 18 C22 42 23 65 29 84', 'M54 30 C66 32 77 31 86 27', 'M53 50 C65 52 77 51 87 47', 'M70 17 C70 42 69 64 65 84 C52 86 50 72 64 69 C76 66 84 73 88 81'],
    'ま': ['M22 27 C42 31 61 30 81 25', 'M23 45 C43 48 62 47 83 42', 'M58 16 C58 41 59 63 56 84 C43 86 39 74 52 70 C66 66 77 74 84 82'],
    'み': ['M31 22 C48 23 59 30 55 45 C50 64 34 82 22 73 C13 66 25 51 44 53 C59 55 73 64 84 78', 'M75 20 C78 42 76 59 69 75'],
    'む': ['M19 34 C40 37 62 35 83 30', 'M50 16 C50 42 48 63 48 77 C48 91 72 88 74 73 C58 76 44 70 37 56', 'M82 53 C88 58 91 66 92 74'],
    'め': ['M29 20 C36 50 53 69 74 82', 'M70 22 C48 29 28 48 27 67 C26 88 58 91 76 71 C88 57 84 37 70 22'],
    'も': ['M47 14 C43 36 41 58 43 75 C45 90 69 86 72 72', 'M25 36 C43 39 61 38 79 33', 'M23 55 C42 58 61 57 80 52'],
    'や': ['M17 45 C38 39 60 32 83 22 C75 45 61 65 45 82', 'M36 19 C45 25 52 33 58 43', 'M47 13 C51 37 56 58 65 80'],
    'ゆ': ['M36 18 C21 38 18 64 34 73 C51 82 70 66 70 45 C70 29 55 23 43 34', 'M63 16 C61 39 60 62 54 84'],
    'よ': ['M45 32 C58 34 70 32 82 28', 'M63 15 C63 41 62 63 59 84 C45 86 42 72 56 69 C69 66 80 75 87 83'],
    'ら': ['M39 18 C51 20 61 23 69 29', 'M31 45 C47 37 73 39 76 56 C80 78 51 87 29 78'],
    'り': ['M34 19 C31 38 31 55 37 69', 'M68 17 C70 42 66 67 47 84'],
    'る': ['M34 23 C50 25 64 24 76 20 C62 35 50 47 38 58 C49 53 71 56 76 70 C82 88 51 92 42 79 C37 70 50 65 60 73'],
    'れ': ['M28 17 C27 39 25 61 24 84', 'M19 48 C31 41 43 34 54 27 C51 44 49 61 50 82 C62 66 74 55 83 63 C91 69 88 80 80 86'],
    'ろ': ['M34 23 C50 25 64 24 76 20 C62 35 50 47 38 58 C51 53 73 57 77 72 C82 88 52 91 36 80'],
    'わ': ['M28 17 C27 39 25 61 24 84', 'M19 48 C31 41 43 34 54 27 C51 44 49 61 50 82 C62 65 80 55 86 70 C91 83 74 91 56 84'],
    'を': ['M21 30 C42 34 62 32 82 27', 'M51 14 C48 38 42 58 31 77 C43 62 65 57 78 65', 'M80 47 C57 55 35 67 35 79 C35 89 55 90 79 82'],
    'ん': ['M35 16 C28 43 21 66 17 84 C36 59 49 52 55 67 C62 86 78 82 88 62'],
};

const STROKE_COLORS = ['#ef4444', '#22c55e', '#0ea5e9', '#d946ef'];

function renderStrokeVisual(card = {}, stepIndex = 0) {
    const paths = HIRAGANA_STROKE_PATHS[card.kana] || [];
    if (!paths.length) {
        return `
            <div class="stroke-guide-grid stroke-guide-fallback">
                <span class="stroke-ghost">${escapeHtml(card.kana || '')}</span>
                <span class="stroke-cumulative">${Array.from({ length: stepIndex + 1 }, (_, i) => i + 1).join('+')}</span>
            </div>
        `;
    }
    return `
        <svg class="stroke-svg" viewBox="0 0 100 100" role="img" aria-label="Nét ${stepIndex + 1} của ${escapeAttr(card.kana || '')}">
            <line x1="50" y1="6" x2="50" y2="94" class="stroke-grid-line"></line>
            <line x1="6" y1="50" x2="94" y2="50" class="stroke-grid-line"></line>
            ${paths.slice(0, stepIndex + 1).map((d, index) => `
                <path d="${escapeAttr(d)}" class="stroke-path" style="--stroke-color:${STROKE_COLORS[index % STROKE_COLORS.length]}"></path>
                <text x="${index === 0 ? 12 : index === 1 ? 40 : index === 2 ? 72 : 18}" y="${index === 0 ? 26 : index === 1 ? 18 : index === 2 ? 70 : 82}" class="stroke-number" fill="${STROKE_COLORS[index % STROKE_COLORS.length]}">${index + 1}</text>
            `).join('')}
            <circle cx="83" cy="83" r="2.4" class="stroke-end-dot"></circle>
        </svg>
    `;
}
